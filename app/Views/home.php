        ...
        <section class="hero-card" onclick="openProductModal('hero')">
            <div class="hero-details">
                ...
                <div class="hero-socials">
                    Follow us on:
                    <span class="social-circle-icon" title="X (Twitter)">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                        </svg>
                    </span>
                    <span class="social-circle-icon" title="TikTok">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.02 1.59 4.23.86.17 1.76.28 2.65.28V8.5c-1.02-.01-2.04-.19-3-.55-.09 1.97-.1 3.94-.06 5.91-.04 1.84-.46 3.69-1.37 5.25-1.37 2.47-4.14 3.99-6.97 3.84-2.85-.09-5.54-1.87-6.52-4.54-1.2-3.11-.08-6.94 2.63-8.77 1.77-1.23 4.09-1.63 6.16-1.1v4.06c-1.03-.43-2.22-.38-3.21.14-.99.55-1.68 1.59-1.81 2.72-.25 1.58.55 3.2 2.02 3.82 1.48.66 3.32.22 4.31-.98.54-.64.83-1.46.81-2.29.04-3.69.02-7.38.03-11.07-.01-.08-.02-.17-.03-.25z"/>
                        </svg>
                    </span>
                    <span class="social-circle-icon" title="Instagram">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <span class="social-circle-icon" title="LinkedIn">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
