    ...
    <div class="wrapper">
        ...
        <div class="panel-left">
            ...
            <?php if (!$is_logged_in): ?>
                ...
                <p class="header-subtitle">Secure access portal to your cPanel hosting system.</p>
            ...
            <?php else: ?>
                <div class="dashboard-header">
                    <div>
                        ...
                        <p class="header-subtitle" style="margin-bottom: 0;">Connected to MilesWeb deployment</p>
                    </div>
                    <div style="text-align: right;">
                        ...
                        <a href="index.php?action=logout" class="btn-logout">Disconnect</a>
                    </div>
                </div>
                ...
                <div class="console-panel">
                    ...
                    <div class="console-line" style="color: var(--accent-pink);">deployment success: 14 files updated.</div>
